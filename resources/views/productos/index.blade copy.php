    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/js/bootstrap.bundle.min.js" integrity="sha384-HwwvtgBNo3bZJJLYd8oVXjrBZt8cqVSpeBNS5n7C8IVInixGAoxmnlMuBnhbgrkm" crossorigin="anonymous"></script>
       <div class="container w-25 border p-4">
            <form action="{{ route('productos') }}" method="post" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label for="caracteristica" class="form-label">Ingrese caracteristica 1 </label>
                    <input type="email" multiple list="lista-caracteristica" class="form-control" name="caracteristica"> 
                </div>
                <div class="mb-3">
